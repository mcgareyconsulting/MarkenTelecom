...
The purpose of the seventy two (72) hours is to load and unload, not to provide storage/parking for the unit. Recreational Vehicles must be stored/parked in the garage, Accessory Building, or off site.
Vehicles shall not be parked on landscaped (i.e., rock, sod, mulch, plants, etc.) areas. Inoperable, unused or unregistered vehicles (legally and/or mechanically) must be kept in a garage or Accessory Building.
"Inoperable, unused or unregistered" shall also mean any automobile, truck, motorcycle, motorbike or recreational vehicle which has not been driven under its own propulsion or has not been moved outside of the Property for a period of two (2) weeks or longer. The foregoing restriction shall not include otherwise permitted vehicles parked by Owners while on vacation or during a period of illness.""",
        },
        "grass": {
            "title": "3.42.2 Landscape Maintenance",
            "code_number": "3.42.2",
        ...
        "landscape installation": {
            "title": "Section 5.10 Landscaping.",
            "code_number": "Section 5.10",
            "violation_name": "Landscaping.",
            "description": """The Owner of each Lot (other than Declarant or a Builder) shall install landscaping on all portions of the Lot which is not covered by a building or Improvement in accordance with the Governing Documents and Applicable Laws. Landscaping plans must be submitted to the ARC for review and approval (which may be with conditions and/or requirements), and such approval shall be obtained prior to the installation of landscaping, in accordance with Article 2 of this Declaration.""",
        },
    },
}
